...
```
my-release-cockroachdb-0    cockroachdb/cockroach:v21.2.0
my-release-cockroachdb-1    cockroachdb/cockroach:v21.2.0
my-release-cockroachdb-2    cockroachdb/cockroach:v21.2.0
my-release-cockroachdb-3    cockroachdb/cockroach:v21.2.0
```
...
Note that there are some backward-incompatible changes to SQL features between versions 20.2 and 21.1. For details, see the [CockroachDB v21.2.0 release notes](https://www.cockroachlabs.com/docs/releases/v21.2.0.html#backward-incompatible-changes).
...
| `image.tag`                                               | Container image tag                                             | `v21.2.0`                                             |
